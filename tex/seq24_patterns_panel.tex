...
\label{paragraph:seq24_patterns_pattern_keys}
   ...
   We're not sure about the functionality of the next keys.  The handling of
...
\label{paragraph:seq24_patterns_pattern_Clicks}
   ...
   Holding down \texttt{Left Ctrl} while selecting a sequence (pattern)
   will mute all other patterns and turn on the selected
   pattern.
