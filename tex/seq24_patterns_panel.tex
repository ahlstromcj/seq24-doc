...
\label{subsubsec:seq24_patterns_pattern_filled}
   ...
   \begin{itemize}
      ...
      \item \textbf{Span}.
         ...
         \index{todo!verify span conjecture} (TODO:  verify this span conjecture)
      \item \textbf{Beat}.
         \index{pattern!beat}
...
\label{paragraph:seq24_patterns_pattern_Clicks}
   ...
   Holding down \texttt{Left Ctrl} while selecting a patter
...
\end{figure}
   ...
   \index{keys!semicolon} The \textbf{semicolon} reduces the BPM;
   \index{keys!apostrophe} The \textbf{apostrophe} increases the BPM.
