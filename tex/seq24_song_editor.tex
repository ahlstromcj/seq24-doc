...
\label{subsubsec:seq24_song_editor_arrangement_panel_roll}
   ...
   \begin{enumber}
      ...
      \item \textbf{Pattern Subsection}.
         ...
         marker in it, breaking the pattern into two equal pieces.  This can
      ...
      \item \textbf{Selection}.
         ...
         \index{keys!ctrl-C}
         Ctrl-C key, and then inserted (one or more times) by the
         \index{keys!ctrl-V}
         Ctrl-V key.  When inserted, each insert goes immediately after the
         current item or the previous insertion.
         The same can be done for whole patterns.
